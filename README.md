About lsp-tree-sitter-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/lsp-tree-sitter-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lsp-tree-sitter-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add lsp-tree-sitter
# for installing globally
pixi global install lsp-tree-sitter
```
...
It is possible to list all of the versions of `lsp-tree-sitter` available on your platform:
...
```
pixi search lsp-tree-sitter --channel conda-forge
```
